...
public class AclAccessControlConfiguration {

    private final DataSource dataSource;

    public AclAccessControlConfiguration(DataSource dataSource) {
    ...
    public EhCacheFactoryBean aclEhCacheFactoryBean() {
        ...
        cacheFactoryBean.setCacheManager(aclCacheManager().getObject());
    ...
    public MethodSecurityExpressionHandler defaultMethodSecurityExpressionHandler() {
        ...
        expressionHandler
            .setPermissionCacheOptimizer(new AclPermissionCacheOptimizer(aclService()));
