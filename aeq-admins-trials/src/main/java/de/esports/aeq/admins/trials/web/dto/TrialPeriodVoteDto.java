...
public class TrialPeriodVoteDto implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TrialPeriodVoteDto)) return false;
        TrialPeriodVoteDto that = (TrialPeriodVoteDto) o;
    ...
    public String toString() {
        return new StringJoiner(", ", TrialPeriodVoteDto.class.getSimpleName() + "[", "]")
                .add("id=" + id)
