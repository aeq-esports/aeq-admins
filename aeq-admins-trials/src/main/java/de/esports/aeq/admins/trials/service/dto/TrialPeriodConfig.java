...
public class TrialPeriodConfig implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TrialPeriodConfig)) return false;
        TrialPeriodConfig that = (TrialPeriodConfig) o;
    ...
    public String toString() {
        return new StringJoiner(", ", TrialPeriodConfig.class.getSimpleName() + "[", "]")
